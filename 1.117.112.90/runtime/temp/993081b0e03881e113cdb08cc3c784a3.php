<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"/www/wwwroot/erp.wangzhi81.com/public/../application/music/view/index/kecheng.html";i:1594791808;}*/ ?>
<!DOCTYPE html>
                    ...
                    $.post("/music/index/getChat",{
                        ...
                        $.each(res,function(i,v){
                            ...
                            if(v.speaker_id==="<?php echo $openid; ?>"){
                                strhtml='<div class="admin-group"><img class="admin-img" src="/static/img/ico/user.png"/><div class="admin-msg"><i class="triangle-admin"></i><pre class="admin-reply">'+v.what_to_say+'</pre></div></div>'+strhtml;
                            }else{
