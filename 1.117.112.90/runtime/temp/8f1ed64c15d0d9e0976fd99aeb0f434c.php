<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"/www/wwwroot/erp.wangzhi81.com/public/../application/index/view/commodity/edit.html";i:1552096538;}*/ ?>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div style="padding:10px;">
            ...
            <div><input type="text" class="form-control" id="trade_name" placeholder="请输入商品名称" value="<?php echo $commodity_management['trade_name']; ?>"></div>
            <div style="padding:5px">商品单价：</div>
            <div><input type="text" class="form-control" id="unit_price" placeholder="请输入商品单价" value="<?php echo $commodity_management['unit_price']; ?>"></div>
                ...
                <div style="border:1px solid #ddd;width:100px">
                    <table style="width:100%">
                        <tr><td valign="middle" align="center" style="height:100px" id="djsc">
                            <img src="<?php echo $commodity_management['commodity_pictures']; ?>" class="img-responsive" id="commodity_pictures">
                        </td></tr>
                    </table>
                </div>
            </div>
            <div style="display:none">
                ...
                <input type="hidden" value="<?php echo $commodity_management['COMMODITY_MANAGEMENT_ID']; ?>" id="COMMODITY_MANAGEMENT_ID">
            </div>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $("#queding").click(function(){
                    ...
                    $.post("/index/Commodity/update",{
                        trade_name:trade_name,
                        commodity_pictures:commodity_pictures,
                        COMMODITY_MANAGEMENT_ID:$("#COMMODITY_MANAGEMENT_ID").val(),
