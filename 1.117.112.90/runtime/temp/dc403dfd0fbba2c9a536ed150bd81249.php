<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"/www/wwwroot/39.99.164.250/public/../application/music/view/index/mykecheng.html";i:1598600934;}*/ ?>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div style="padding:10px">
            <table width="100%">
                <tr>
                    <td><input type="text" class="form-control" id="cxtj" placeholder="查询全部课程" value=""></td>
        ...
        <script>
            ...
            function chaxun(){
                //if($("#cxtj").val().trim()!=''){
                    $.post("/music/index/chaxun2",{
                        cxtj:$("#cxtj").val()
                    },function(res){
                        ///alert(res);
                        var html = "";
                        $.each(res,function(i,v){
                            html+='<tr class="kclbclass" COURSE_INFORMATION_ID="'+v.COURSE_INFORMATION_ID+'"><td style="width:40%;padding:10px" valign="top"><img src="'+v.course_pictures+'" class="img-responsive img-rounded"></td><td style="padding:10px" valign="top"><div style="height:30px">'+v.course_title+'</div><div style="font-size:20px;color:#EF7C38"></div><table width="100%"><tr><td><img src="/static/img/ico/user2.png" style="width:20px"><span style="color:#cdcdcd">'+v.teaching_teacher+'</span></td><td align="right"><img src="/static/img/ico/guanzhu.png" style="width:20px"><span style="color:#cdcdcd">'+v.number_of_learners+'</span></td></tr></table></td></tr>';
                        });
                        $("#kclb").html(html);
