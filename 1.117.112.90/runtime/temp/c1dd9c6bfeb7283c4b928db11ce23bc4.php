<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"/www/wwwroot/39.99.164.250/public/../application/music/view/shop/myzy.html";i:1599528263;}*/ ?>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div style="padding:10px">
            <table width="100%">
                <tr>
                    <td><input type="text" class="form-control" id="cxtj" placeholder="查询全部资源" value=""></td>
        ...
        <script>
            function chaxun(){
                $.post("/music/shop/getmyzy",{
                    cxtj:$("#cxtj").val().trim()
                },function(res){
                    var html = "";
                    $.each(res,function(i,v){
                        html+='<tr style="border-bottom-width: 1px;border-bottom-style: solid;border-bottom-color:#cdcdcd" class="spitme" DOWNLOAD_RESOURCES_ID="'+v.DOWNLOAD_RESOURCES_ID+'">                <td style="width:30%;padding:5px" valign="top">                    <img src="'+v.resource_image+'" class="img-responsive">                </td>                <td style="padding:5px" valign="top">                    <div style="height:40px;margin-top:5px">'+v.resource_name+'</div>                    <div>                        <table width="100%">                            <tr>                                <td>                                    <span style="color:#EF7C38;">已购买</span>                                    <span style="text-decoration:line-through;color:#cdcdcd"></span>                                </td>                                <td align="right">                                    <span style="color:#cdcdcd"></span>                                </td>                            </tr>                        </table>                    </div>                </td>            </tr>';
                    });
                    $("#sptable").html(html);
