<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"/www/wwwroot/erp.wangzhi81.com/public/../application/index/view/customer/add.html";i:1549857014;}*/ ?>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div style="padding:10px;">
            ...
            <div><input type="text" class="form-control" id="full_name" placeholder="请输入客户姓名"></div>
            <div style="padding:5px">手机号码：</div>
            <div><input type="text" class="form-control" id="mobile_phone" placeholder="请输入手机号码"></div>
            <div style="padding:5px">发货地址：</div>
            <div><input type="text" class="form-control" id="shipping_address" placeholder="请输入发货地址"></div>
