<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"/www/wwwroot/39.99.164.250/public/../application/music/view/shop/bjdz.html";i:1598092768;}*/ ?>
<!DOCTYPE html>
    ...
    <body>
        ...
        <table width="100%">
            <tr>
                ...
                <td style="border-bottom-width: 1px;border-bottom-style: solid;border-color:#cdcdcd"><input style="width:100%;border-width:0px" placeholder="收件人姓名" id="addressee" value="<?php echo $shipping_address['addressee']; ?>"></td>
            </tr>
            <tr>
                <td style="width:10px"></td>
                <td style="padding:10px;width:100px;border-bottom-width: 1px;border-bottom-style: solid;border-color:#cdcdcd">联系电话</td>
                <td style="border-bottom-width: 1px;border-bottom-style: solid;border-color:#cdcdcd"><input style="width:100%;border-width:0px" placeholder="联系电话" id="contact_number" value="<?php echo $shipping_address['contact_number']; ?>"></td>
            </tr>
            <tr>
                <td style="width:10px"></td>
                <td style="padding:10px;width:100px;border-bottom-width: 1px;border-bottom-style: solid;border-color:#cdcdcd">所在地区</td>
                <td style="border-bottom-width: 1px;border-bottom-style: solid;border-color:#cdcdcd"><input style="width:100%;border-width:0px" placeholder="精确到区县" id="location" value="<?php echo $shipping_address['location']; ?>"></td>
            </tr>
            <tr>
                <td style="width:10px"></td>
                <td style="padding:10px;width:100px;border-bottom-width: 1px;border-bottom-style: solid;border-color:#cdcdcd">详细地址</td>
                <td style="border-bottom-width: 1px;border-bottom-style: solid;border-color:#cdcdcd"><input style="width:100%;border-width:0px" placeholder="精确到街道、小区、门牌号" id="detailed_address" value="<?php echo $shipping_address['detailed_address']; ?>"></td>
            </tr>
        </table>
        ...
        <script>
            $(document).ready(function() {
                $("#dibu").click(function(){
                    ...
                    $.post("/music/shop/updatedz",{
                        SHIPPING_ADDRESS_ID:"<?php echo $shipping_address['SHIPPING_ADDRESS_ID']; ?>",
