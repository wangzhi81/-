<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"/www/wwwroot/erp.wangzhi81.com/public/../application/index/view/erp/register.html";i:1544453326;}*/ ?>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div style="padding:10px">
            ...
            <div style="height:10px"></div>
            <div style="padding:10px">
                <button class="btn btn-primary btn-lg btn-block" type="button" id="register">注册</button>
            </div>
        </div>
