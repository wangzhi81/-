...
class Businesshall extends Controller
{
    ...
    public function index()
    {
        ...
        $Feature->TableHeader = array("营业厅名称","地址","负责人","联系电话","显示顺序");
        $Feature->Fields = array("BUSINESS_HALL_ID","business_hall_name","address","person_in_charge","contact_number","display_order");
